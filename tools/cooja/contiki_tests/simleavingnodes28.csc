...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <firmware>[CONTIKI_DIR]/examples/rime/leavingnodes28.sky</firmware>
...
while (true) {
  ...
  <plugin>
    Mobility
    <plugin_config>
      <positions EXPORT="copy">[CONTIKI_DIR]/tools/cooja/apps/mobility/positionsleavingnodes28.dat</positions>
    </plugin_config>
    <width>500</width>
    <z>3</z>
    <height>200</height>
